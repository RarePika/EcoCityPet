...
public class BridgeManager
{
    ...
    {
        Class entityBridgeType = Class.forName("com.dsh105.echopet.bridge.platform."
                + serverIdent.toLowerCase() + "entity.type." + serverIdent + type + "EntityBridge");
        String bridgeClassName = entityBridgeType.getCanonicalName().replace(entityBridgeType.getSimpleName(), "platform." + serverIdent.toLowerCase() + "." + serverIdent + entityBridgeType.getSimpleName());
        try
        {
