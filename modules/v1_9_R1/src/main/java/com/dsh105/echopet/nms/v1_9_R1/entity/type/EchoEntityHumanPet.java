...
public class EchoEntityHumanPet extends EntityCreature implements IAnimal, EchoEntityPetHandle, EntityHumanPet
{

    private EntityPetModifier<HumanPet> modifier;

    public EchoEntityHumanPet(World world)
    {
        super(world);
    }

    public EchoEntityHumanPet(World world, HumanPet pet)
    {
        super(world);
    ...
    @Override
    public EntityPetModifier<HumanPet> getModifier()
    {
        return modifier;
    }
