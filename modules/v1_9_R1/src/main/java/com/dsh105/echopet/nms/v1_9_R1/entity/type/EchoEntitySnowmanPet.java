...
public class EchoEntitySnowmanPet extends EntitySnowman implements IAnimal, EchoEntityPetHandle, EntitySnowmanPet
{

    private EntityPetModifier<SnowmanPet> modifier;

    public EchoEntitySnowmanPet(World world)
    {
        super(world);
    }

    public EchoEntitySnowmanPet(World world, SnowmanPet pet)
    {
        super(world);
    ...
    @Override
    public SnowmanPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<SnowmanPet> getModifier()
    {
        return modifier;
    }
