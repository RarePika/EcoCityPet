...
public class EchoEntityWolfPet extends EntityWolf implements IAnimal, EchoEntityPetHandle, EntityWolfPet
{
    ...
    private EntityPetModifier<WolfPet> modifier;

    public EchoEntityWolfPet(World world)
    {
        super(world);
    }

    public EchoEntityWolfPet(World world, WolfPet pet)
    {
        super(world);
    ...
    @Override
    public WolfPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<WolfPet> getModifier()
    {
        return modifier;
    }
