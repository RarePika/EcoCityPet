...
public class EchoEntitySpiderPet extends EntitySpider implements IAnimal, EchoEntityPetHandle, EntitySpiderPet
{

    private EntityPetModifier<SpiderPet> modifier;

    public EchoEntitySpiderPet(World world)
    {
        super(world);
    }

    public EchoEntitySpiderPet(World world, SpiderPet pet)
    {
        super(world);
    ...
    @Override
    public SpiderPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<SpiderPet> getModifier()
    {
        return modifier;
    }
