...
public class EchoEntityGhastPet extends EntityGhast implements IAnimal, EchoEntityPetHandle, EntityGhastPet
{

    private EntityPetModifier<GhastPet> modifier;

    public EchoEntityGhastPet(World world)
    {
        super(world);
    }

    public EchoEntityGhastPet(World world, GhastPet pet)
    {
        super(world);
    ...
    @Override
    public void setCourseChangeCounter(int value)
    {
        h = value;
    }

    @Override
    public String getAggressionCounterFieldName()
    {
        return "br";
    }

    @Override
    public GhastPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<GhastPet> getModifier()
    {
        return modifier;
    }
