...
package com.dsh105.echopet.nms.v1_9_R1.entity;
...
import com.dsh105.echopet.nms.v1_9_R1.NMSEntityUtil;
...
public class EchoEntityPetBase<T extends Pet> implements EntityPetModifier<T>
{
    ...
    public boolean canSee(Object entity)
    {
        ...
        return getHandle().getEntitySenses().a(((CraftEntity) entity).getHandle());
    }
    ...
    {
        return entity.getGoalTarget().getBukkitEntity();
    }
    ...
    {
        return entity.passengers.isEmpty() ? null : entity.passengers.get(0).getBukkitEntity();
    }
    ...
    {
        entity.setLocation(position.getX(), position.getY(), position.getZ(), position.getYRotation(), position.getXRotation());
    }
