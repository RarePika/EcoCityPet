...
public class EchoEntityGiantPet extends EntityGiantZombie implements IAnimal, EchoEntityPetHandle, EntityGiantPet
{

    private EntityPetModifier<GiantPet> modifier;

    public EchoEntityGiantPet(World world)
    {
        super(world);
    }

    public EchoEntityGiantPet(World world, GiantPet pet)
    {
        super(world);
    ...
    @Override
    public GiantPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<GiantPet> getModifier()
    {
        return modifier;
    }
