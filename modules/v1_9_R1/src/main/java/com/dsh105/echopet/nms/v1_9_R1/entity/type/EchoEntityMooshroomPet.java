...
public class EchoEntityMooshroomPet extends EntityMushroomCow implements IAnimal, EchoEntityPetHandle, EntityMooshroomPet
{

    private EntityPetModifier<MooshroomPet> modifier;

    public EchoEntityMooshroomPet(World world)
    {
        super(world);
    }

    public EchoEntityMooshroomPet(World world, MooshroomPet pet)
    {
        super(world);
    ...
    @Override
    public MooshroomPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<MooshroomPet> getModifier()
    {
        return modifier;
    }
