...
public class EchoEntityCowPet extends EntityCow implements IAnimal, EchoEntityPetHandle, EntityCowPet<CowPet>
{

    private EntityPetModifier<CowPet> modifier;

    public EchoEntityCowPet(World world)
    {
        super(world);
    }

    public EchoEntityCowPet(World world, CowPet pet)
    {
        super(world);
    ...
    @Override
    public CowPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<CowPet> getModifier()
    {
        return modifier;
    }
