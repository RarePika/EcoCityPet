...
public class EchoEntityWitherPet extends EntityWither implements IAnimal, EchoEntityPetHandle, EntityWitherPet
{
    ...
    private EntityPetModifier<WitherPet> modifier;

    public EchoEntityWitherPet(World world)
    {
        super(world);
    }

    public EchoEntityWitherPet(World world, WitherPet pet)
    {
        super(world);
    ...
    @Override
    public WitherPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<WitherPet> getModifier()
    {
        return modifier;
    }
