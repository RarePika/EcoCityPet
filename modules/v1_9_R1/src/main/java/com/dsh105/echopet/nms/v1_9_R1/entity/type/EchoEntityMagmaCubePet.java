...
public class EchoEntityMagmaCubePet extends EntityMagmaCube implements IAnimal, EchoEntityPetHandle, EntityMagmaCubePet
{

    private EntityPetModifier<MagmaCubePet> modifier;

    public EchoEntityMagmaCubePet(World world)
    {
        super(world);
    }

    public EchoEntityMagmaCubePet(World world, MagmaCubePet pet)
    {
        super(world);
    ...
    @Override
    public MagmaCubePet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<MagmaCubePet> getModifier()
    {
        return modifier;
    }
    ...
    protected void bq()
    {
        // do nothing; no targeting
    }

    @Override
    protected boolean bT()
    {
        // nope, no damaging players
        return false;
    }
}