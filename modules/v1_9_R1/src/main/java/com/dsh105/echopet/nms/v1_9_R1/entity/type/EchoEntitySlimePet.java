...
public class EchoEntitySlimePet extends EntitySlime implements IAnimal, EchoEntityPetHandle, EntitySlimePet
{

    private EntityPetModifier<SlimePet> modifier;

    public EchoEntitySlimePet(World world)
    {
        super(world);
    }

    public EchoEntitySlimePet(World world, SlimePet pet)
    {
        super(world);
    ...
    @Override
    public SlimePet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<SlimePet> getModifier()
    {
        return modifier;
    }
