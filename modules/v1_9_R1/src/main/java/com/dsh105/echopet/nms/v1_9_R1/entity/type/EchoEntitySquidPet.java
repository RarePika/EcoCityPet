...
public class EchoEntitySquidPet extends EntitySquid implements IAnimal, EchoEntityPetHandle, EntitySquidPet
{

    private EntityPetModifier<SquidPet> modifier;

    public EchoEntitySquidPet(World world)
    {
        super(world);
    }

    public EchoEntitySquidPet(World world, SquidPet pet)
    {
        super(world);
    ...
    @Override
    public SquidPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<SquidPet> getModifier()
    {
        return modifier;
    }
