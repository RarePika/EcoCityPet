...
public class EchoEntityZombiePet extends EntityZombie implements IAnimal, EchoEntityPetHandle, EntityZombiePet
{
    ...
    private EntityPetModifier<ZombiePet> modifier;

    public EchoEntityZombiePet(World world)
    {
        super(world);
    }

    public EchoEntityZombiePet(World world, ZombiePet pet)
    {
        super(world);
