...
public class EchoEntityOcelotPet extends EntityOcelot implements IAnimal, EchoEntityPetHandle, EntityOcelotPet
{
    ...
    private EntityPetModifier<OcelotPet> modifier;

    public EchoEntityOcelotPet(World world)
    {
        super(world);
    }

    public EchoEntityOcelotPet(World world, OcelotPet pet)
    {
        super(world);
    ...
    @Override
    public OcelotPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<OcelotPet> getModifier()
    {
        return modifier;
    }
