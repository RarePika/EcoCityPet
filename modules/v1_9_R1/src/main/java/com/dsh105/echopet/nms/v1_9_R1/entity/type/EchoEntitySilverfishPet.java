...
import com.dsh105.echopet.api.entity.pet.type.SilverfishPet;
...
public class EchoEntitySilverfishPet extends EntitySilverfish implements IAnimal, EchoEntityPetHandle, EntitySilverfishPet
{

    private EntityPetModifier<SilverfishPet> modifier;

    public EchoEntitySilverfishPet(World world)
    {
        super(world);
    }

    public EchoEntitySilverfishPet(World world, SilverfishPet pet)
    {
        super(world);
    ...
    @Override
    public SilverfishPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<SilverfishPet> getModifier()
    {
        return modifier;
    }
    ...
    /*
     * EntitySilverfish stuff
     */

    public void onLive()
    {
        // TODO - this may or may not work well
        /*if (this.target == null && !this.bS()) {
            // prevent it from despawning i.e. block-ifying
            this.target = ((CraftPlayer) getPet().getOwner()).getHandle();
        }*/
    }
}