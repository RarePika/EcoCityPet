...
public class EchoEntityBatPet extends EntityBat implements IAnimal, EchoEntityPetHandle, EntityBatPet
{

    private EntityPetModifier<BatPet> modifier;

    public EchoEntityBatPet(World world)
    {
        super(world);
    }

    public EchoEntityBatPet(World world, BatPet pet)
    {
        super(world);
    ...
    @Override
    public BatPet getPet()
    {
        return modifier.getPet();
    }

    @Override
    public EntityPetModifier<BatPet> getModifier()
    {
        return modifier;
    }
