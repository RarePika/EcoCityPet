...
public class BukkitServerUtil
{
    ...
    public static List<Player> getOnlinePlayers()
    {
        ...
        try
        {
            ...
            {
                Collection<Player> playerCollection = (Collection<Player>) onlinePlayersMethod.invoke(null);
            ...
            {
                onlinePlayers = Arrays.asList((Player[]) onlinePlayersMethod.invoke(null));
            }
        }
