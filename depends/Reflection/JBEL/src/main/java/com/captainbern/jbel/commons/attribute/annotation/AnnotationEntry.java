...
package com.captainbern.jbel.commons.attribute.annotation;
...
import com.captainbern.jbel.commons.attribute.annotation.elementvalue.ElementValuePair;
...
public class AnnotationEntry implements Opcode
{
    ...
    {
        return this.constantPool.getUtf8(this.index).getString();
    }
    ...
    public void addElementValue(ElementValuePair elementValuePair)
    {
