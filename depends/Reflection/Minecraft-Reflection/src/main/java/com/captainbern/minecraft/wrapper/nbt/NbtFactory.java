...
public class NbtFactory
{
    ...
    public static <T> WrappedNbtTag<T> createTag(NbtType type)
    {
        ...
        if (CREATE_TAG == null)
        {
            ...
            methods = nbtBase.getSafeMethods(withReturnType(MinecraftReflection.getNbtBaseClass()), withArguments(byte.class));
    ...
    public static NbtTagCompound saveItemStack(ItemStack itemStack, NbtTagCompound tagCompound)
    {
        ...
        if (ITEMSTACK_SAVE == null)
        {
            ...
            List<SafeMethod<Object>> candidates = template.getSafeMethods(withReturnType(nbtTagCompound), withArguments(nbtTagCompound));
    ...
    public static ItemStack loadItemStack(NbtTagCompound tagCompound)
    {
        ...
        if (ITEMSTACK_LOAD == null)
        {
            ...
            List<SafeMethod<Object>> candidates = template.getSafeMethods(withReturnType(MinecraftReflection.getItemStackClass()), withArguments(nbtTagCompound));
        ...
        if (TO_BUKKIT_ITEMSTACK == null)
        {
            ...
            // Candidates...
            List<SafeMethod<ItemStack>> candidates = template.getSafeMethods(withReturnType(ItemStack.class), withArguments(MinecraftReflection.getItemStackClass()));
