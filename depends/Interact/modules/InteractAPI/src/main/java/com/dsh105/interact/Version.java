...
public class Version
{
    ...
    public static final String PLUGIN_ID = "${global.id}";
    public static final String PLUGIN_NAME = "${global.name}";
    public static final String PLUGIN_VERSION = "${global.version}";
}